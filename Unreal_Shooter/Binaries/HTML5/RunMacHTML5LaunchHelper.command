...
if [ -f "D:\Program Files (x86)\Epic Games\4.9\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\Program Files (x86)\Epic Games\4.9\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
